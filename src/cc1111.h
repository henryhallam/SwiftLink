/*
  CC1111/CC1110 register and bit definitions
  Henry Hallam, Fergus Noble 2011
*/
 ...
 * Timer 2 (MAC timer)
 */
__sfr __at 0x9C T2CT;     //timer 2 count
__sfr __at 0x9D T2PR;     //timer 2 prescaler
__sfr __at 0x9E T2CTL;   //timer 2 control
#define T2CTL_TEX		(1 << 6)
#define T2CTL_INT		(1 << 4)
#define T2CTL_TIG		(1 << 2)
#define T2CTL_TIP_MASK (3)
#define T2CTL_TIP_64	(0)
#define T2CTL_TIP_128	(1)
#define T2CTL_TIP_256	(2)
#define T2CTL_TIP_1024 (3)
